...
const SmartChatbot = () => {
  ...
  const handleQuickAction = (action) => {
    ...
    const actionMap = {
      ...
      'Security Guide': () => window.open('https://docs.hexalabs.online/security'),
      'Get Connection Info': '/vm/vmdetails',
      'Troubleshoot Access': () => handleQuickQuestion('how to access vm'),
      'View Features': '/dashboard',
      'Quick Start Guide': () => window.open('https://docs.hexalabs.online/quickstart'),
      'Pricing Info': '/vm/billing',
      'Search Events': '/vm/logs',
      'Export Logs': '/vm/logs',
      'Set Alerts': '/vm/monitoring',
      'Performance Tips': () => window.open('https://docs.hexalabs.online/performance'),
