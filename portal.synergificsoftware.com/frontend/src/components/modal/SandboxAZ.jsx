...
export const CreateUserModal = ({ onClose, onCreateUser, loading }) => {
    ...
    const handleCreateUser = (e) => {
        e.preventDefault();
        if (!username.trim() || !personalEmail.trim() || !duration) return;
        onCreateUser({ username, personalEmail, duration });  // Passing the object
        onClose();
    };
