    ...
    const template = `
      <div style="width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); font-family: Arial, sans-serif; background-color: #f4f4f4;">
        <div style="padding: 20px; background-color: #ffffff; border-radius: 8px;">
          ...
          <p style="font-size: 16px; color: #333;">Thank you for placing an order with <b>HexaLabs</b>. We are pleased to inform you that your requested Virtual Machines (VMs) have been successfully created and are ready for use.</p>
          ...
          <ol style="font-size: 16px; color: #333;">
            <li>Login to <a href="https://portal.hexalabs.online/" style="color: #1a73e8;">Integrated Cloud Portal</a>.</li>
