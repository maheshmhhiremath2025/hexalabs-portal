...
router.get('/:id/pdf', async (req, res) => {
  try {
    ...
    // Header
    pdf.fontSize(10).fillColor(gray).text('HexaLabs Cloud Portal', 50, 50);
    ...
    // Footer
    pdf.moveDown(2);
    pdf.fontSize(8).fillColor(gray).text('This report was auto-generated by HexaLabs Cloud Portal.', { align: 'center' });
